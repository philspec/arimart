...
export default function ProductsPage() {
  ...
  if (error) return <div className="container mx-auto px-4 py-8 text-center min-h-screen bg-emerald-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100">{error}</div>
